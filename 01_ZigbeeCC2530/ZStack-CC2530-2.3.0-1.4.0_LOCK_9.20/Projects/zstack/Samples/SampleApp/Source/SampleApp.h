...
extern void AD_Init( uint8 task_id );

extern void MY_Test_Init(uint8 task_id);

extern void Beep_Warn_Init(uint8 task_id);
/*
...
extern UINT16 AD1_ProcessEvent( uint8 task_id, uint16 events );

extern uint16 Beep_Warn_ProcessEvent( uint8 task_id, uint16 events );

extern   void Start_State(void);
/*********************************************************************
*********************************************************************/
extern void Motor_IO_Init(void);
extern void Delayms(unsigned int xms); //i=xms º¥—” ± i ∫¡√Î
#ifdef __cplusplus
}
#endif
