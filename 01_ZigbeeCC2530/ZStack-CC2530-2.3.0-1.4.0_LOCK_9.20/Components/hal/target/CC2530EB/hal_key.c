...
/* SW_6 is at P0.1 ---by Cavani*/
#define HAL_KEY_SW_6_PORT   P1   //1、配置IO口（野火Zigbee的S1在P0_4）
#define HAL_KEY_SW_6_BIT    BV(5)
#define HAL_KEY_SW_6_SEL    P1SEL
#define HAL_KEY_SW_6_DIR    P1DIR

/* edge interrupt */
#define HAL_KEY_SW_6_EDGEBIT  BV(6)
#define HAL_KEY_SW_6_EDGE     HAL_KEY_RISING_EDGE //2、P0上升沿触发中断
